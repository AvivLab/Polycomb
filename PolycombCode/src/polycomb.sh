...
CMDFILE=/gs/gsfs0/users/avibergm/Polycomb/julia1.1.1_MarylNewVersionWithTwoEnvs_Aug2019/filesToZipOfJulia1.1.1-MarylMultipleEnvironmentsCode/src/polycomb_var.txt
